 ...
 * @LastEditTime: 2025-04-17 18:59:41
...
router.get('/', async function (req: express.Request, res: express.Response, next: express.NextFunction) {
  try {
    res.type('html')
    res.send(
      '<html> <head>时忆APP-IOS下载</head><body><h1> This page was render direcly from the server <p>Hello there welcome to my website</p></h1> <a class="blink ios" href="itms-services://?action=download-manifest&url=https://xxxx/cmdr.plist">IOS下载</a> </body></html>'
    )
  } catch (err) {
